...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
  <div class="wizard-content">
    <form class="tab-wizard wizard-circle wizard" action="javascript:void(0)" method="POST" id="form-cadastrar-aluno">
      <!-- Dados pessoais -->
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" id="estado_emissor" name="estado_emissor" class="form-control">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
...
<script src="/assets/alunos.js" defer></script>
@stop
